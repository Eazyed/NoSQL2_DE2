CREATE TABLE eventDataStreaming(
...
date_occur_evt_formatted  STRING COMMENT 'date métier d’occurrence de l’événement formatted par apache flume, format YYYY-MM-DD',
